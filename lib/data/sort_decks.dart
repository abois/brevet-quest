...
class SortDecks {
  ...
  static const List<SortDeck> all = <SortDeck>[
    ...
    SortDeck(
      ...
      subjectId: 'maths',
      categories: <SortCategory>[
        SortCategory(label: 'Quadrilatères', emoji: '⬛'),
        SortCategory(label: 'Triangles', emoji: '🔺'),
        SortCategory(label: 'Solides', emoji: '🎲'),
      ],
      items: <SortItem>[
        SortItem(label: 'Carré', categoryIndex: 0),
        SortItem(label: 'Rectangle', categoryIndex: 0),
        SortItem(label: 'Losange', categoryIndex: 0),
        SortItem(label: 'Équilatéral', categoryIndex: 1),
        SortItem(label: 'Rectangle (en A)', categoryIndex: 1),
        SortItem(label: 'Isocèle', categoryIndex: 1),
        SortItem(label: 'Cube', categoryIndex: 2),
        SortItem(label: 'Pyramide', categoryIndex: 2),
        SortItem(label: 'Cylindre', categoryIndex: 2),
      ],
    ),
    SortDeck(
      id: 'continents',
      title: 'Pays par continent',
      emoji: '🌍',
      subjectId: 'histoire-geo',
      categories: <SortCategory>[
        SortCategory(label: 'Europe', emoji: '🇪🇺'),
        SortCategory(label: 'Amériques', emoji: '🌎'),
        SortCategory(label: 'Asie', emoji: '🌏'),
      ],
      items: <SortItem>[
        SortItem(label: 'Allemagne', categoryIndex: 0),
        SortItem(label: 'Espagne', categoryIndex: 0),
        SortItem(label: 'Suède', categoryIndex: 0),
        SortItem(label: 'Brésil', categoryIndex: 1),
        SortItem(label: 'Canada', categoryIndex: 1),
        SortItem(label: 'Mexique', categoryIndex: 1),
        SortItem(label: 'Japon', categoryIndex: 2),
        SortItem(label: 'Inde', categoryIndex: 2),
        SortItem(label: 'Corée du Sud', categoryIndex: 2),
      ],
    ),
    SortDeck(
      id: 'energies',
      ...
      subjectId: 'sciences',
      categories: <SortCategory>[
        SortCategory(label: 'Renouvelable', emoji: '🌱'),
        SortCategory(label: 'Fossile', emoji: '🛢️'),
        SortCategory(label: 'Nucléaire', emoji: '☢️'),
      ],
      items: <SortItem>[
        SortItem(label: 'Solaire', categoryIndex: 0),
        SortItem(label: 'Éolien', categoryIndex: 0),
        SortItem(label: 'Hydraulique', categoryIndex: 0),
        SortItem(label: 'Pétrole', categoryIndex: 1),
        SortItem(label: 'Charbon', categoryIndex: 1),
        SortItem(label: 'Gaz naturel', categoryIndex: 1),
        SortItem(label: 'Uranium 235', categoryIndex: 2),
        SortItem(label: 'Plutonium', categoryIndex: 2),
        SortItem(label: 'Fission nucléaire', categoryIndex: 2),
      ],
    ),
    SortDeck(
      id: 'tense-en',
      ...
      subjectId: 'anglais',
      categories: <SortCategory>[
        SortCategory(label: 'Present', emoji: '🕐'),
        SortCategory(label: 'Past', emoji: '⏪'),
        SortCategory(label: 'Future', emoji: '⏩'),
      ],
      items: <SortItem>[
        SortItem(label: 'I eat', categoryIndex: 0),
        SortItem(label: 'I am eating', categoryIndex: 0),
        SortItem(label: 'I have eaten', categoryIndex: 0),
        SortItem(label: 'I ate', categoryIndex: 1),
        SortItem(label: 'I was eating', categoryIndex: 1),
        SortItem(label: 'I had eaten', categoryIndex: 1),
        SortItem(label: 'I will eat', categoryIndex: 2),
        SortItem(label: 'I am going to eat', categoryIndex: 2),
        SortItem(label: 'I will have eaten', categoryIndex: 2),
      ],
    ),
  ];
}
