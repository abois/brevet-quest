...
class _GameMemoryScreenState extends State<GameMemoryScreen> {
  ...
  void _setupDeck() {
    ...
    final List<MemoryPair> pairs = List<MemoryPair>.of(MemoryDecks.all[idx])
      ..shuffle(rng);
    final List<MemoryPair> selected = pairs.take(8).toList();
    _deckName = MemoryDecks.deckNames[idx];
    _deckEmoji = MemoryDecks.deckEmojis[idx];
    _subjectId = switch (_deckName) {
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text(_deckEmoji, style: const TextStyle(fontSize: 14)),
